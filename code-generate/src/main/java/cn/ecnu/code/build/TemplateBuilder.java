...
import cn.ecnu.code.swagger.*;
import cn.ecnu.code.util.JavaTypes;
import cn.ecnu.code.util.ModelInfo;
import cn.ecnu.code.util.StringUtils;
...
public class TemplateBuilder {
    ...
    static {
        try {
            ...
            AUTHOR = props.getProperty("code.author");
...
//                ResultSet tableResultSet = metaData.getTables(null, "%", "%", new String[]{"TABLE"});
                ResultSet tableResultSet = metaData.getTables(database, null, null, new String[]{"TABLE"});
