...
import cn.ecnu.oauth.util.UserJwt;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        Enterprise user = userService.findByAccount(username);
        //创建User对象
        String permissions = "salesman,accountant,user";
        UserJwt userDetails = new UserJwt(username, user.getPassword(),AuthorityUtils.commaSeparatedStringToAuthorityList(user.getAuthorities()));
        return userDetails;
    }
}
