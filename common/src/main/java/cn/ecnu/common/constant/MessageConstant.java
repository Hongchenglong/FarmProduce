...
public class MessageConstant {
    ...
    public static final String INSERT_SETMEAL_SUCCESS = "新增套餐成功";
    public static final String INSERT_SETMEAL_FAIL = "新增套餐失败";
    ...
    public static final String GET_PERMISSION_FAIL = "查询权限列表数据失败";
    public static final String GET_PERMISSION_SUCCESS = "查询权限列表数据成功";
    ...
    public static final String QUERY_ROLE_SUCCESS = "查询角色失败";
    public static final String QUERY_ROLE_FAIL = "查询角色失败";
    public static final String DELETE_ROLE_SUCCESS = "删除角色失败";
    ...
    public static final String EDIT_MENU_SUCCESS = "编辑菜单失败";
